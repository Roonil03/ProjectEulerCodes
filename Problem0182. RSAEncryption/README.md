...
Generate two distinct primes $p$ and $q$.<br>Compute $n = pq$ and $\phi = (p - 1)(q - 1)$.<br>
...
An issue when choosing $e$ is that there should not be too many unconcealed messages.<br>For instance, let $p = 19$ and $q = 37$.<br>
